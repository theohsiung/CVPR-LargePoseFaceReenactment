...
def main(args):
    ...
    for i, frame in tqdm(enumerate(reader)):
        ...
        if len(queue_ver) >= n:
            ...
            all = np.zeros((516, 772, 3), np.uint8)
            img_crop2 = cv2.resize(img_crop2, (128,128))

            img_crop = cv2.resize(img_crop, (128,128))
            img_crop_2 = cv2.resize(img_crop_2, (128,128))
            img_crop_3 = cv2.resize(img_crop_3, (128,128))
            img_crop_4 = cv2.resize(img_crop_4, (128,128))

            all[:128, :128, :] = img_crop2 # ref
            all[:128, 388:516, :] = img_crop2 #ref
            all[260:388, :128, :] = img_crop2 #ref3
            all[260:388, 388:516, :] = img_crop2 #ref4

            all[128:256, :128, :] = img_crop
            all[128:256, 388:516, :] = img_crop_2
            all[388:, :128, :] = img_crop_3
            all[388:, 388:516, :] = img_crop_4

            all[:256, 128:384, :] = img_fake
            all[:256, 516:, :] = img_fake_2
            all[260:, 128:384, :] = img_fake_3
            all[260:, 516:, :] = img_fake_4
            #==========================================================
